...
<a onClick="return confirm('Yakin Ingin Menghapus?')" class="btn btn-danger" href="hapus_data.php?id=<?php echo $data['id_pengaduan'] ?>" role="button"><i class="fa fa-remove"></i>Hapus</a>
<div class="dropdown">
