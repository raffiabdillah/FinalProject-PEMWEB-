...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="img/slide1.jpg">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-md-6 ">
                         <li><a href="https://www.google.co.id/maps/place/Universitas+Pembangunan+Nasional+Veteran+Jawa+Timur/@-7.3337212,112.7857498,17z/data=!3m1!4b1!4m6!3m5!1s0x2dd7fab87edcad15:0xb26589947991eea1!8m2!3d-7.3337212!4d112.7883247!16s%2Fm%2F0g9vdrk?entry=ttu" style="color:white">
                         <i class="fa fa-podcast"> UPN "Veteran" Jawa Timur</i></a></li>
                        </div>
                        <div class="col-xl-6 col-md-6">
                            <div class="short_contact_list">
                                <ul>
                                    <li><a href="mailto:humas@upnjatim.ac.id"> <i class="fa fa-envelope"></i>humas@upnjatim.ac.id</a></li>
                                    <li><a href="#"> <i class="fa fa-phone"></i>(0623) 18706369</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text">
                                ...
                                <p>Selamat datang di web Pengaduan Tindak Kejahatan UPN "Veteran" Jawa Timur<br>
