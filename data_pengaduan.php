...
<input type="text" name="cr" placeholder="Cari User Mahasiswa" style="width:20%; padding:8px; margin-top:5px; margin-bottom:5px" class="form_input" />
<input type="submit" style="margin-top:10px" class="btn btn-outline-dark my-2 my-sm-0" style="padding:8px" name="cari" value="Cari Data" />
    ...
    <table class="table1" align="center" width="100%"> 
        <tr>
            ...
            <th>Foto</th>
            <th>Status</th>
            <th><a class="btn btn-dark" style="float:left;" href="cetak_pengaduan.php" role="button" target="_blank"><i class="fa fa-print"></i> Cetak PDF</a> </th>
            <th><a class="btn btn-dark" style="float:left;" href="cetak_mahasiswa_excel.php" role="button" target="_blank"><i class="fa fa-print"></i> Cetak Excel</a> </th> 
        </tr>
<?php
$batas =10;
...
$query = mysqli_query ($conn, "SELECT * FROM pengaduan WHERE nama_pengadu LIKE '%".$cari."%'
	OR npm LIKE '%".$cari."%' OR tgl_pengaduan LIKE '%".$cari."%' OR status LIKE '%".$cari."%'");
}else{
...
<td><a href="http://localhost/ukom_aipp/image/<?php echo $data['foto'];?>"><img src="image/<?php echo $data['foto'];?>" height="60px"></a></td>
<td></td>
...
<input type="hidden" name="jenis_kelamin" class="form_input2" value="<?php echo $data['jenis_kelamin']?>">
<input type="hidden" name="npm" class="form_input2" value="<?php echo $data['npm']?>">
...
<div class="row">
    <div class="col-md-6">
        ...
        <a onClick="return confirm('Yakin Ingin Menghapus?')" class="btn btn-danger" href="hapus_data.php?idd=<?php echo $data['id_pengaduan'] ?>" role="button">
            <i class="fa fa-remove"></i>Hapus
        </a>
    </div>
    <div class="col-md-6">
        <div class="dropdown">
            <button class="btn btn-dark dropdown-toggle" type="button" id="dropdownMenuButton" style="width:auto" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
