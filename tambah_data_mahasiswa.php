...
?> 
                                     ...
                                     <i class="fa fa-file-archive-o" style="color:white"><li><a class="active" href="data_mahasiswa.php">Data Mahasiswat</a></li></i>
            ...
            <div class="single_slider  d-flex align-items-center slider_bg_2 overlay2">
             ...
             <div class="slider_text ">
                                <h1 style="color:white">Admin/Petugas<br>
                                    Web Pengaduan Tindak Kejahatan Mahasiswa</h1>
...
<tr>
<td><h7>NPM</h7></th><td><input type="text" name="NPM" class="form_input2" required  placeholder="NPM 11 Digit" minlength="11" maxlength="11" onkeypress="return hanyaAngka(event)"></td>
</tr>
<tr>
