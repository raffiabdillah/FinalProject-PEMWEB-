...
include 'koneksi.php';
$id = $_GET ['id'];
$p = mysqli_query ($conn, "SELECT * FROM data_mahasiswa WHERE id_mahasiswa = '$id'");
...
if (isset($_POST['simpan'])){
	...
	$edit = mysqli_query ($conn, "UPDATE data_mahasiswa SET id_mahasiswa='$id',nama='$nama',jenis_kelamin='$jenis_kelamin',npm='$npm',fakultas='$fakultas',program_studi='$program_studi',no_telp='$no_telp' WHERE id_mahasiswa ='$id'");
	if($edit){
		...
		echo "<meta http-equiv='refresh' content='1;url=edit_data_mahasiswa.php'>";
		}
		}
?>
    ...
    <p class="tulisan_input2">edit data mahasiswa</p>
    <table class="table2" width="40%" align="center">
<form method="post">
<td><input type="hidden" name="id" value="<?php echo $data['id_mahasiswa']?>"></td>
</tr>
<tr>
<td><h7>NAMA</h7></td><td><input type="text" name="nama" class="form_input2" required value="<?php echo $data['nama']?>"></td>
</tr>
<tr>
<td><h7>JENIS KELAMIN</h7></th><td><input type="text" name="jenis_kelamin" class="form_input2" required value="<?php echo $data['jenis_kelamin']?>"></td>
</tr>
<tr>
...
<tr>
<td><h7>FAKULTAS</h7></th><td><input type="text" name="fakultas" class="form_input2" required  value="<?php echo $data['fakultas']?>"></td>
</tr>
<tr>
<td><h7>PROGRAM STUDI</h7></th><td><input type="text" name="program_studi" class="form_input2" required  value="<?php echo $data['program_studi']?>"></td>
</tr>
<tr>
...
<td colspan="2"><button type="submit" class="btn btn-success" name="simpan" style="float:left; margin-right:25px;">Edit disini</button>
                <a class="btn btn-dark" href="data_mahasiswa.php" role="button" style="float:right">Kembali <i class="fa fa-sign-out" style="color:white"></i></a>
