...
if (isset($_POST ['login'])) {
				$user = $_POST['user'];
				$pass = $_POST['pass'];
				$data_user = mysqli_query ($conn,"SELECT * FROM mahasiswa WHERE username ='$user' AND password ='$pass'");
				...
				if ($user == $username && $pass == $password) {
					...
					$_SESSION['npm'] = $NPM;
					$_SESSION['no_telp'] = $tlp;
		echo "<div class='alert alert-success'>Login Sukses</div>";
		echo "<meta http-equiv='refresh' content='1;url=mahasiswa_admin.php'>";
		} else {
