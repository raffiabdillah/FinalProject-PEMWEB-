...
if(isset($_GET['id_laporan'])){
    $idd = $_GET['id_laporan'];
    $p = mysqli_query($conn, "SELECT * FROM tanggapan WHERE isi_laporan = '$id'");
...
<body>
    ...
    <div class="project_area">
        ...
        <form method="post">
            ...
            <?php if (isset($data['tgl_tanggapan'])) { ?>
                <center>
            ...
            <?php } else { ?>
                <center>
                    <h4 style="margin-top:20px">Belum Ditanggapi</h4>
                </center>
            <?php } ?>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <p class="copy_right text-center">
                        ...
                        &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">UPN "Veteran" Jawa Timur</a>
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </p>
                </div>
            </div>
