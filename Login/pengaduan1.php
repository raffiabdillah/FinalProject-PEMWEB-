...
$no =1;		 
$npm = $_SESSION['npm'];
$query = mysqli_query($conn,"SELECT * FROM pengaduan WHERE npm = '$npm'");
...
<td><?=$data ['status'] ?></td>
<td><a class="btn btn-success" style="float:left" href="tanggapan_mahasiswa.php?id_laporan=<?php echo $data['isi_laporan'] ?>" role="button"><i class="fa fa-eye"></i>Lihat Tanggapan</a></p>
<?php }}else{
