...
include 'koneksi.php';
$id = $_GET ['id'];
$p = mysqli_query ($conn, "SELECT * FROM petugas WHERE id_petugas = '$id'");
...
if (isset($_POST['simpan'])){
	...
	$tlp = $_POST ['tlp'];
	$level = $_POST ['level'];
	$edit = mysqli_query ($conn, "UPDATE petugas SET id_petugas='$id',nama_petugas='$nama',username='$user',password='$pass',tlp='$tlp',level='$level' WHERE id_petugas ='$id'");
	if($edit){
