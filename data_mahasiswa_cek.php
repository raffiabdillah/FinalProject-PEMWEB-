...
<head>
    ...
    <title>CEK DATA MAHASISWA</title>
...
?> 
    ...
    <p class="tulisan_input2">Data Mahasiswa</p>
...
$query = mysqli_query ($conn, "SELECT * FROM data_mahasiswa WHERE NPM LIKE '%".$cari."%'
	...
	$query = mysqli_query ($conn, "SELECT * FROM data_mahasiswa");
}
...
<td>
<a class="btn btn-success" href="user_mahasiswa.php" role="button">Kembali <i class="fa fa-sign-out"></i></a>
</td>
</tr>
<?php }}else{
