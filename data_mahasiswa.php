...
?> 
    ...
    <table class="table1" align="center" width="100%">
		<tr>
            ...
            <th>Program Studi</th>
            <th>No Telepon</th>
            <th><a class="btn btn-dark" style="float:left;" href="tambah_data_mahasiswa.php" role="button"><i class="fa fa-user-plus"></i> Tambah</a></th>
</tr>
<?php 
$batas =6;
...
$query = mysqli_query ($conn, "SELECT * FROM data_mahasiswa WHERE npm LIKE '%".$cari."%'
	OR nama LIKE '%".$cari."%' OR npm LIKE '%".$cari."%'");}else{
...
<a onClick="return confirm('Yakin Ingin Menghapus?')" class="btn btn-danger" href="hapus_data_mahasiswa.php?id=<?php echo $data['id_mahasiswa'] ?>" role="button"><i class="fa fa-remove"></i>Hapus</a>
</form></td>
</tr>
<?php }}else{
