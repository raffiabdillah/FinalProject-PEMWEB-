...
<head>
    ...
    <title>PETUGAS : DATA PENGADUAN</title>
...
?> 
                                     ...
                                     <i class="fa fa-file-archive-o" style="color:white"><li><a class="active" href="data_mahasiswa_ptgs.php">Data Mashasiswa</a></li></i>
...
$query = mysqli_query ($conn, "SELECT * FROM pengaduan WHERE nama_pengadu LIKE '%".$cari."%'
	OR npm LIKE '%".$cari."%' OR tgl_pengaduan LIKE '%".$cari."%' OR status LIKE '%".$cari."%'");}else{
...
?>
<tr>
<td width="10%"><?php echo $data['id_pengaduan'] ?></td>
<td width="10%"><?php echo $data['tgl_pengaduan'] ?></td>
<td width="10%"><?php echo $data['nama_pengadu'] ?></td>
<td width="10%"><?php echo $data['jenis_kelamin'] ?></td>
<td width="10%"><?php echo $data['npm'] ?></td>
<td width="30%"><?php echo $data['isi_laporan'] ?></td>
<td width="10%"><?php echo $data['tlp'] ?></td>
...
<td>
    <div class="row">
        <div class="col-md-6">
            ...
            <a onClick="return confirm('Yakin Ingin Menghapus?')" class="btn btn-danger" href="hapus_data_ptgs.php?id=<?php echo $data['id_mahasiswa'] ?>" role="button"><i class="fa fa-remove"></i>Hapus</a>        </div>
    </div>
</td>
<td width="10%">
<div class="dropdown">
...
<form method="post" action="data_mahasiswa_cek_ptgs.php">
<input type="hidden" name="cr" value="<?php echo $data['npm'] ?>" />
