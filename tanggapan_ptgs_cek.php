...
<head>
    ...
    <title>CEK TANGGAPAN PETUGAS</title>
...
?> 
    ...
    <p class="tulisan_input2">TANGGAPAN LAPORAN mahasiswa</p>
<form method="post">

<center><h4 style="margin-top:20px">Ditanggapi Tanggal: <?= $data ['tanggapan']?></h4></center>
<div style="font-style:normal; font-family:Verdana, Geneva, sans-serif">
<b><textarea rows="7px" style="width:100%;"><?= $data ['tgl_tanggapan']?></textarea></b>
</div>
<div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">UPN "Veteran" Jawa Tengah</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                </div>
